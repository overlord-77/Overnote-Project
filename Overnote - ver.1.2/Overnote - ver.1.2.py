...
"""
Overnote version 1.2 on Branch -> Exe <- From Branch -> Main <-
...
class MainApp(ctk.CTk):
    def __init__(self, title, size):
        ...
        icon_path = self.resource_path("D:/X-OneDrive/Python/- Python Scripts - Projects  -/Overnote/Overnote - ver.1.2/assets/o_icon.ico") #------------------------------> Un-comment once turning it into an exe | re comment it once being updates 
