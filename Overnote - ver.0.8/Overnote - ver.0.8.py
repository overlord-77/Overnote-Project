...
"""
Overnote version 0.8 on Branch -> Exe <- From Branch -> Main <-
...
class MainApp(ctk.CTk):
    def __init__(self, title, size):
        ...
        icon_path = self.resource_path("assets/o_icon.ico") #------------------------------> Un-comment once turning it into an exe | re comment it once being updates 
