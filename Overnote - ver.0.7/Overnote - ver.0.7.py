...
"""
Overnote version 0.7 on Branch -> Exe <- From Branch -> Main <-
...
class MainTextArea(tk.Text):
    def __init__(self, parent):
        ...
        self.pack(expand = True, fill = 'y', side='top')
...
class LeftOptionsBar(ctk.CTkFrame):
    def __init__(self, parent, status_bar_frame):
        ...
        view_menu = View_Menu(left_option_bar_menu, status_bar_frame)
        ...
        left_option_bar_menu.add_command(label='𝐁', command= lambda: print('Bold Text'))
        left_option_bar_menu.add_command(label='𝐼', command= lambda: print('Italic Text'))
    ...
    def __init__(self, parent, status_bar_frame, tearoff=False):
        ...
        def status_bar_func():
            if status_bar_var.get() == "on":
                self.status_bar_frame.pack(expand = False, fill='x', side= 'bottom')
...
class Setting_Window(ctk.CTkToplevel):
    ...
    def __init__(self, parent):
        ...
        right_frame.pack(side="left", fill="y", expand=False)

        about_this_app_label = ctk.CTkLabel(right_frame, text= ' About this app                                          ')
        about_this_app_label.pack(expand=False, fill= 'both')

        about_this_app_label2 = ctk.CTkLabel(right_frame, text= 'Overnote 0.6                                          ')
        about_this_app_label2.pack(expand=False, fill= 'both')

        about_this_app_label3 = ctk.CTkLabel(right_frame, text= '                          C 2025 Treadway. All rights reserved.                        ')
...
class StatusBarFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        frame_one_text_count = ctk.CTkFrame(self, fg_color="#202020")
        frame_one_text_count.pack(expand = True, side= 'left', fill = 'x')

        frame_two_text_formatted = ctk.CTkFrame(self, fg_color="#202020")
        frame_two_text_formatted.pack(expand = True, side= 'left', fill = 'x')

        frame_three_text_type = ctk.CTkFrame(self, fg_color="#202020")
